  ...
  const plans = [
    {
      name: "Starter Plan",
      description:
        "Ideal for growing businesses ready to scale with a clear strategy.",
      price: "$80",
      features: [
    ...
    },
    {
      ...
      description:
        "Designed for scaling businesses that need full control and dedicated support.",
      price: "$260",
      features: [
              ...
              <div className="mb-8">
                {plan.featured ? (
                  <button className="w-full bg-white text-blue-800 font-bold py-3 rounded-full flex items-center justify-center gap-2 hover:bg-blue-50 transition-colors">
                    {plan.cta}{" "}
                    <div className="p-1 rounded-full bg-blue-700 text-white">
